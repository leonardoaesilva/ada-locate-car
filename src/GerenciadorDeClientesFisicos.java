...
public class GerenciadorDeClientesFisicos {
    private final InterfaceDeDados<PessoaFisica> dadosDeClientesFisicos;

    public GerenciadorDeClientesFisicos(InterfaceDeDados<PessoaFisica> dadosDeClientesFisicos) {
